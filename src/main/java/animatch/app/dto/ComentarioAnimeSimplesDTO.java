...
public class ComentarioAnimeSimplesDTO {
    private int id;
    ...
    public ComentarioAnimeSimplesDTO() {
    }

    public ComentarioAnimeSimplesDTO(int id, String texto, LocalDate data, int qtdLikes, int qtdDeslikes) {
        this.id = id;
        this.texto = texto;
        this.data = data;
